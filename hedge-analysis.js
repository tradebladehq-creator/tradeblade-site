(() => {
  ...
  function HedgeAnalysis() {
    ...
    return /* @__PURE__ */ React.createElement("div", { style: {
      ...
      marginBottom: 20,
      textAlign: "center"
    } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontFamily: font, color: C.green, letterSpacing: 2, textTransform: "uppercase", marginBottom: 6 } }, "\u{1F4B0} LIVE HEDGE ACCOUNT CAPITAL NEEDED"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 36, fontWeight: 900, fontFamily: sansFont, color: C.green, lineHeight: 1.1 } }, "$", capital.recIntraday.toLocaleString()), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: C.dim, fontFamily: sansFont, marginTop: 6 } }, "Recommended for intraday trading \xB7 includes ", capital.maxContracts, " ", inst.micro, " margin + worst-case drawdown + 25% buffer"), /* @__PURE__ */ React.createElement("div", { style: {
      display: "flex",
      justifyContent: "center",
      gap: 24,
      marginTop: 14,
      flexWrap: "wrap"
    } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: C.faint, fontFamily: font, letterSpacing: 1 } }, "WORST-CASE LOSS"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: C.red, fontFamily: font } }, "$", capital.worstCaseLoss.toFixed(0))), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: C.border } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: C.faint, fontFamily: font, letterSpacing: 1 } }, "MARGIN (", inst.micro, ")"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: C.cyan, fontFamily: font } }, "$", capital.intradayMargin.toLocaleString())), /* @__PURE__ */ React.createElement("div", { style: { width: 1, background: C.border } }), /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center" } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: C.faint, fontFamily: font, letterSpacing: 1 } }, "OVERNIGHT CAPABLE"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 16, fontWeight: 700, color: C.amber, fontFamily: font } }, "$", capital.recOvernight.toLocaleString())))), /* @__PURE__ */ React.createElement(Section, { title: "Account Configuration", icon: "\u{1F4B2}", accent: C.amber }, /* @__PURE__ */ React.createElement("div", { style: {
      background: C.card,
      padding: 16,
      borderRadius: 8,
      border: `1px solid ${C.border}`,
